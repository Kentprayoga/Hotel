<?php
include 'backend/get_fasilitas.php'; // Memasukkan data fasilitas dari database
?>
...
<body>
    ...
    <div class="my-5 px-4" style="margin-top: 80px;">
        <!-- Tambahkan margin-top jika perlu -->
        ...
        <p class="text-center mt-3">Kami memiliki fasilitas dan perlengkapan fisik yang dapat memudahkan anda dalam
            ...
            Rasakan kenyamanan maksimal dengan fasilitas lengkap di hotel kami, dan nikmati pengalaman menginap yang tak
            terlupakan <br>
            dengan pelayanan ramah dan suasana yang nyaman, dirancang untuk memenuhi segala kebutuhan Anda selama
            berlibur atau berbisnis!
        </p>
    </div>

    <div class="container" style="margin-bottom: 40px;">
        <!-- Margin-bottom untuk memberi jarak dari footer -->
        <div class="row">
